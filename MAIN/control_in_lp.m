...
for var = {'phi', 'theta'}; i=i+1;
    ...
    switch var
        case 'phi'
            ...
            subplot(2,2,3), impulse( ss( Ad-Bd*k, [0;hs], k*Ix,  0, hs) );  % u control action - phi torque
        ...
        case 'theta'
            ...
            subplot(2,2,3), impulse( ss( Ad-Bd*k, [0;hs], k*Iy,  0, hs) );  % u control action - theta torque
